...
<div class="uk-section">
        ...
        <div class="">
            <div class="uk-grid-small uk-child-width-1-2@m uk-margin-medium-bottom" uk-grid>
                ...
                <div class="uk-text-right">
                    <a class="uk-button uk-button-primary uk-border-rounded" href="{{ route('candidatos.create') }}"> Novo candidato</a>
    ...
    <table class="uk-table uk-table-hover uk-table-middle uk-table-divider">
        ...
        @foreach ($candidatos as $candidato)
            <tr>
            <td>{{ ++$i }}</td>
            <td class="uk-table-link">{{ $candidato->foto }}</td>
            <td>{{ $candidato->nome }}</td>
            <td>
            
                @if($candidato->sbot) SBOT @endif
                @if($candidato->coomtoce) COOMTOCE @endif

            </td>
            <td class="actions">               
                <!-- <a class="" href="{{ route('candidatos.show',$candidato->id) }}" uk-tooltip="Ver">
                ...
                <a class="" href="{{ route('candidatos.edit',$candidato->id) }}" uk-tooltip="Editar">
                ...
                <a href="#modal-center-{{$candidato->id}}" uk-toggle id="js-modal-confirm" uk-tooltip="Excluir">
